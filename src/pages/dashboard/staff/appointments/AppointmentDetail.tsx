...
function statusLabel(s?: string) {
  switch (s) {
    case "pending":
      return { text: "Chờ xử lý", variant: "secondary" as const };
    case "assigned":
...
export default function AppointmentDetail() {
  ...
  const handleCancel = async () => {
    ...
    try {
      ...
      else alert(res.message || "Không thể hủy lịch hẹn");
    } catch {
    ...
    <main className="flex-1 container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Chế độ chỉ xem. Phân công kỹ thuật viên diễn ra tự động trên hệ thống.
        </p>
      </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <label className="text-sm text-muted-foreground">Giờ hẹn</label>
              ...
              <div>
                ...
                <div className="mt-1">
                  <Badge variant={statusLabel(appointment.status).variant}>
                    {statusLabel(appointment.status).text}
                  </Badge>
                </div>
              </div>
              <div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <label className="text-sm text-muted-foreground">Hãng</label>
                <p className="text-sm">
              ...
              <div>
                ...
                <p className="text-sm">
                  {(appointment.vehicle_id as unknown as { color?: string })
                    ?.color || "—"}
                </p>
              </div>
            </div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-4">
              * Phân công kỹ thuật viên tự động dựa trên slot trống. Nhân viên
              chỉ xem thông tin.
            </p>
          </CardContent>
        </Card>
